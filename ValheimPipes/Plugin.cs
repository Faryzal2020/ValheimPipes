    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            ExtraCompatiblePrefabs = Config.Bind("Compatibility", "Extra Compatible Prefabs", "BCP_ClayCollector,RDP_beehive",
                new ConfigDescription("A comma-separated list of prefab names to try to make them compatible with hoppers and pipes (not always works).", null, syncedAttr));
            ...
            AddBronzePiece("HopperBronzeSideways", 6, 4);
            ...
            AddIronPiece("HopperIronSideways", 6, 2);
